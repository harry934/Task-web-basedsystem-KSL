...
var NAV_ITEMS = [
  { id: 'dashboard', label: 'Dashboard', group: 'Work', svg: '<path d="M3 13h8V3H3v10zm10 8h8V11h-8v10zM3 21h8v-6H3v6zm10-18v6h8V3h-8z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader', 'Employee'] },
  { id: 'mytasks', label: 'My Tasks', group: 'Work', svg: '<path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader', 'Employee'] },
  ...
  { id: 'progress', label: 'Progress', group: 'Work', svg: '<path d="M5 9h3v10H5V9zm6-4h3v14h-3V5zm6 8h3v6h-3v-6z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader', 'Employee'] },
  ...
  { id: 'employees', label: 'Employees', group: 'Organisation', svg: '<path d="M12 12c2.2 0 4-1.8 4-4s-1.8-4-4-4-4 1.8-4 4 1.8 4 4 4zm0 2c-2.7 0-8 1.3-8 4v2h16v-2c0-2.7-5.3-4-8-4z"/>', roles: ['Administrator', 'Manager'] },
  { id: 'notifications', label: 'Notifications', group: 'Admin', svg: '<path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.1-1.6-5.6-4.5-6.3V4c0-.8-.7-1.5-1.5-1.5S10.5 3.2 10.5 4v.7C7.6 5.4 6 7.9 6 11v5l-2 2v1h16v-1l-2-2z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader', 'Employee'] },
