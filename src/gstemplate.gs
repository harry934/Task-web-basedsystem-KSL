...
var NAV_ITEMS = [
  ...
  { id: 'deployment', label: 'Deployment', group: 'Work', svg: '<path d="M12 2C8.1 2 5 5.1 5 9c0 5.2 7 13 7 13s7-7.8 7-13c0-3.9-3.1-7-7-7zm0 9.5c-1.4 0-2.5-1.1-2.5-2.5S10.6 6.5 12 6.5s2.5 1.1 2.5 2.5S13.4 11.5 12 11.5z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader', 'Employee', 'Staff'] },
  ...
  { id: 'employees', label: 'Staff', group: 'Organisation', svg: '<path d="M12 12c2.2 0 4-1.8 4-4s-1.8-4-4-4-4 1.8-4 4 1.8 4 4 4zm0 2c-2.7 0-8 1.3-8 4v2h16v-2c0-2.7-5.3-4-8-4z"/>', roles: ['Administrator', 'Manager', 'Supervisor', 'Team Leader'] },
  ...
  { id: 'users', label: 'Login accounts', group: 'Admin', svg: '<path d="M12 1L3 5v6c0 5.6 3.8 10.7 9 12 5.2-1.3 9-6.4 9-12V5l-9-4zm0 10.2a2.5 2.5 0 110-5 2.5 2.5 0 010 5zm0 6.8c-2.1 0-4-.9-5.2-2.3.1-1.7 3.5-2.6 5.2-2.6s5.1.9 5.2 2.6C16 17.1 14.1 18 12 18z"/>', roles: ['Administrator'] },
